...
Use this file as the map; do not preload large documentation into agent context.

- `../PROJECT_STATE.md` — current decisions, working features and next work.
- `../AGENTS.md` — short permanent agent rules.
- `../config/sources.json` — official monitoring sources and cadence metadata.
